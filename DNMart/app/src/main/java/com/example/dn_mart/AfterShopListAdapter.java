...
public class AfterShopListAdapter extends RecyclerView.Adapter<AfterShopListAdapter.ViewHolder>{
        ...
        public AfterShopListAdapter(List<AfterShopListModel> list_datas, Context context, FragmentManager fragmentManager,UserInfo userInfo) {
        ...
        @NonNull
        @Override
        public AfterShopListAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.aftershoprecycleviewlist,parent,false);
            return new AfterShopListAdapter.ViewHolder(view);
        }

        @Override
        public void onBindViewHolder(@NonNull final AfterShopListAdapter.ViewHolder holder, int position) {
