...
import com.example.dn_mart.SearchModel;
import com.example.dn_mart.Singleton;
import com.example.dn_mart.Utils;
import com.example.dn_mart.ViewProducts;
...
public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.ViewHolder>{
    ...
    public SearchAdapter(List<SearchModel> list_datas, Context context, FragmentManager fragmentManager,UserInfo userInfo) {
    ...
    public void onBindViewHolder(@NonNull final SearchAdapter.ViewHolder holder, int position) {
        SearchModel listData=list_datas.get(position);
        ...
        holder.cart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                StringRequest stringRequest=new StringRequest ( Request.Method.POST ,
                        Utils.SEARCH_BAR_URL, new Response.Listener <String> () {
