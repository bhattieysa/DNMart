...
$sql= "SELECT * FROM `orderlist` WHERE MONTH(`date`)='$Month' AND YEAR(`date`)='$Year'";
...
?>
 ...
 <div id="page-wrapper">
    ...
    <form method="post" enctype="multipart/form-data" >
      <input type="text" name="month" Placeholder="Enter month(ie.02)" required> <br><br>
      ...
      <button  name="submit" class="btn btn-primary btn-user btn-block">submit</button>
              <h1> <?php   
   if(isset($_POST['submit'])){
      echo "Your Entered month sale is: ".$row1; 
