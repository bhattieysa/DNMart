...
$search = $_POST['search'];
    ...
    $query = "SELECT * FROM `orderlist` WHERE name LIKE '%$search%' AND status!='pending'";
 ...
 <div id="page-wrapper">
    ...
    <?php
                    if(isset($_POST['submit']))
                    {
                        ...
                        echo "<marquee><h1> Click particular product name! you want to see <strong>details</strong> from given table</h1></marquee>";
                        echo "
                       <tr>
                        <th>name</th>
                        <th>address</th>
